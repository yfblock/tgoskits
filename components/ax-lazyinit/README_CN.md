...
`ax-lazyinit` 提供了 Initialize a static value lazily。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-lazyinit 派生自 https://github.com/arceos-org/lazyinit
...
在线文档：[docs.rs/ax-lazyinit](https://docs.rs/ax-lazyinit)
