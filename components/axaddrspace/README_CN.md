...
`axaddrspace` 提供了 ArceOS-Hypervisor guest address space management module。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。
