...
`ax-config-gen` 提供了 A TOML-based configuration generation tool for ArceOS。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-config-gen 派生自 https://github.com/arceos-org/axconfig-gen
...
在线文档：[docs.rs/ax-config-gen](https://docs.rs/ax-config-gen)
