...
`ax-driver-input` 提供了 Common traits and types for input device drivers。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-driver-input 派生自 https://github.com/arceos-org/axdriver_crates
...
在线文档：[docs.rs/ax-driver-input](https://docs.rs/ax-driver-input)
