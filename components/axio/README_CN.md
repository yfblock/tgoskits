...
`ax-io` 提供了 `std::io` for `no_std` environment。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-io 派生自 https://github.com/arceos-org/io
...
在线文档：[docs.rs/ax-io](https://docs.rs/ax-io)
