...
`ax-plat-macros` 提供了 Procedural macros for the `axplat` crate。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-plat-macros 派生自 https://github.com/arceos-org/axplat_crates
...
在线文档：[docs.rs/ax-plat-macros](https://docs.rs/ax-plat-macros)
