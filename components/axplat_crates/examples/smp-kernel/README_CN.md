...
`smp-kernel` 提供了 smp-kernel component for TGOSKits。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。
...
在线文档：[docs.rs/smp-kernel](https://docs.rs/smp-kernel)
