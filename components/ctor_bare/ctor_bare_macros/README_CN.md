...
`ax-ctor-bare-macros` 提供了 Macros for registering constructor functions for Rust under no_std。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-ctor-bare-macros 派生自 https://github.com/arceos-org/ctor_bare
...
fn main() {
    // 在这里将 `ax-ctor-bare-macros` 集成到你的项目中。
}
```
...
在线文档：[docs.rs/ax-ctor-bare-macros](https://docs.rs/ax-ctor-bare-macros)
