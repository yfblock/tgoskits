...
`ax-riscv-plic` 提供了 RISC-V platform-level interrupt controller (PLIC) register definitions and basic operations。它是 TGOSKits 组件集合的一部分，可用于集成 ArceOS、AxVisor 及相关底层系统软件的 Rust 项目。


> ax-riscv-plic 派生自 https://github.com/arceos-org/riscv_plic
...
在线文档：[docs.rs/ax-riscv-plic](https://docs.rs/ax-riscv-plic)
