...
pub type LvtLint0RegisterMmio = ReadWrite<u32, LVT_LINT0::Register>;

/// A read-write copy of LVT LINT0 Register (FEE0 0350H).
///
...
pub type LvtLint0RegisterLocal = LocalRegisterCopy<u32, LVT_LINT0::Register>;
